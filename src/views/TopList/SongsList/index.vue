  ...
  <div class="songslist">
    <div class="u-title">
      ...
      <div class="more s-fc3">
        播放：<strong class="s-fc6">{{ playCount }}</strong
        >次
      </div>
    </div>
      ...
      >
        <thead>
          <tr>
            ...
            <th class="w2">
              <div class="wp" style="width: 215px">标题</div>
            </th>
            <th class="w3">
              <div class="wp">时长</div>
            </th>
        ...
        <tbody>
          ...
          >
            <td class="left">
              <div class="hd" style="width: 54px">
                <span
                  class="ply"
                  ref="ply"
                  @click="playSong(item, playList, item.id)"
                  v-show="item.isPlay"
                ></span>
                <span
                  class="ply_red"
                ...
                <div class="tt">
                  <div class="ttc">
                    <span class="txt">
                      ...
                      >
                      <span v-for="(value, indexes) in item.alia" :key="indexes"
                        >-{{ value }}</span
                      >
                      <span
                        class="mv"
            ...
            <td>
              <div class="text" style="width: 152px">
                <a
                  href="#"
...
export default {
  ...
  methods: {
    async getplayList(id = 19723756) {
      this.loading = true
      await this.$store.dispatch('playlist/getPlayList', { id, limit: 100 })
      this.loading = false
    },
